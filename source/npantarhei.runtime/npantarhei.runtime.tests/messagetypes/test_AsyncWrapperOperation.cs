...
namespace npantarhei.runtime.tests.messagetypes
{
    ...
    public class test_AsyncWrapperOperation
    {
        ...
        {
            var sut = new AsyncWrapperOperation(new Asynchronize<IMessage>(), new Operation("throw", (input, continueWith, unhandledException) => { throw new ApplicationException("xxx"); }));
            sut.Start();
            try
            {
